package tcp.microservices.config.client.aspects;
...
public class ActuatorAspect {
	...
	@AfterReturning("execution(* tcp.microservices.config.client.service.impl.ServiceActuatorServiceImpl.doOtherthing(..))")
